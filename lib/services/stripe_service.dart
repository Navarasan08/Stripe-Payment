...
import 'package:stripe_example/data/keys.dart';
...
class StripeService {
  ...
  static String secret = PrivateKeys.stripeSecret;
  ...
  static init() {
    StripePayment.setOptions(
        StripeOptions(
            publishableKey: PrivateKeys.stripePublishableKey,
            merchantId: "Test",
            androidPayMode: 'test'
        )
    );
  ...
  static Future<StripeTransactionResponse> payWithNewCard({String amount, String currency}) async {
    try {
      // step 1 - request data with new form
